import { Plugin, Maybe, ExecutionResult, ObjMap } from '@envelop/core';
import { ExecutionArgs } from 'graphql';
import type { Cache } from './cache.cjs';
/**
 * Function for building the response cache key based on the input parameters
 */
export declare type BuildResponseCacheKeyFunction = (params: {
...
export declare type GetDocumentStringFunction = (executionArgs: ExecutionArgs) => string;
...
export declare type ResponseCacheExtensions = {
    hit: true;
} | {
    hit: false;
    didCache: false;
...
export declare type ResponseCacheExecutionResult = ExecutionResult<ObjMap<unknown>, {
