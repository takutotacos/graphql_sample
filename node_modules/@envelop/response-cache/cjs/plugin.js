...
exports.useResponseCache = exports.defaultShouldCacheResult = exports.defaultBuildResponseCacheKey = void 0;
...
const cache_document_str_js_1 = require("./cache-document-str.js");
/**
...
function useResponseCache({ cache = (0, in_memory_cache_js_1.createInMemoryCache)(), ttl: globalTtl = Infinity, session, enabled, ignoredTypes = [], ttlPerType = {}, ttlPerSchemaCoordinate = {}, idFields = ['id'], invalidateViaMutation = true, buildResponseCacheKey = exports.defaultBuildResponseCacheKey, getDocumentString = cache_document_str_js_1.defaultGetDocumentString, shouldCacheResult = exports.defaultShouldCacheResult, 
...
includeExtensionMetadata = typeof process !== 'undefined' ? process.env['NODE_ENV'] === 'development' : false, }) {
    ...
    return {
        onPluginInit({ addPlugin }) {
            if (getDocumentString === cache_document_str_js_1.defaultGetDocumentString) {
                addPlugin((0, cache_document_str_js_1.useCacheDocumentString)());
            }
        },
        async onExecute(onExecuteParams) {
            let documentChanged = false;
            const newDocument = (0, graphql_1.visit)(onExecuteParams.args.document, {
                SelectionSet(node) {
